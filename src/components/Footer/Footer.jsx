...
export default function Footer() {
  ...
  return (
    <div className="footer">
      <div
        className={
          userFeed.fetchValue === "followedUserPosts"
            ? "icon-details-selected"
            : "icon-details"
        }
        onClick={goToHome}
      >
      ...
      <div
        onClick={() =>
          userFeedDispacher({
            type: "MANAGE_NEW_POSTS",
          })
        }
      >
        <FaRegPlusSquare size="2em" />
        <span className="icon-name">Post</span>
      </div>

      <div
        className={
          userFeed.fetchValue === "bookMarkView"
            ? "icon-details-selected"
            : "icon-details"
        }
